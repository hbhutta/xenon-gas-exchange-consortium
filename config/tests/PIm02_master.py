...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "data/PIm0028" # "data/scanfolder" # Output files saved here (e.g. mask_reg_edited.nii)
        self.manual_seg_filepath = "data/mask_reg_edited.nii" # f"data/scanfolder/{self.subject_id}/mask_reg_edited.nii"
        self.manual_reg_filepath = "" # Haad: What do we do with this?
        ...
        self.segmentation_key = constants.SegmentationKey.CNN_VENT.value # constants.SegmentationKey.MANUAL_VENT.value
        #for manual: constants.SegmentationKey.MANUAL_VENT.value
        #for automatic: constants.SegmentationKey.CNN_VENT.value (uses a CNN to predict the mask)
        ...
        self.hb = 0.0
        self.rbc_m_ratio = 0.0 # Haad: Set to 0 to trigger else case in subject_classmap.calculate_rbc_m_ratio()
